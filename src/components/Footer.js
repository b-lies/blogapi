          ...
          <div className="row justify-content-between">
            ...
            <div className="col-md-6">
              <div className="social-links mb-3 mb-lg-0 text-center text-md-end">
                <a href="1" className="twitter"><i className="bi bi-twitter"></i></a>
                <a href="2" className="facebook"><i className="bi bi-facebook"></i></a>
                <a href="3" className="instagram"><i className="bi bi-instagram"></i></a>
                <a href="4" className="google-plus"><i className="bi bi-skype"></i></a>
                <a href="5" className="linkedin"><i className="bi bi-linkedin"></i></a>
              </div>
